...
public class TbWebServerDAOImpl extends BaseIbatisDaoSupport implements TbWebServerDAO {
    /**
    ...
    public int countByExample(TbWebServerExample example) throws SQLException {
        Integer count = (Integer)  sqlMapClient.queryForObject("tb_web_server.countByExample", example);
        return count;
    }
    ...
    public int deleteByExample(TbWebServerExample example) throws SQLException {
        int rows = sqlMapClient.delete("tb_web_server.deleteByExample", example);
        return rows;
    }
    ...
    public int deleteByPrimaryKey(String id) throws SQLException {
        ...
        _key.setId(id);
        int rows = sqlMapClient.delete("tb_web_server.deleteByPrimaryKey", _key);
        return rows;
    }
    ...
    public List<TbWebServer> selectByExample(TbWebServerExample example) throws SQLException {
        List<TbWebServer> list = sqlMapClient.queryForList("tb_web_server.selectByExample", example);
        return list;
    }
    ...
    public TbWebServer selectByPrimaryKey(String id) throws SQLException {
        TbWebServer _key = new TbWebServer();
        _key.setId(id);
        TbWebServer record = (TbWebServer) sqlMapClient.queryForObject("tb_web_server.selectByPrimaryKey", _key);
        return record;
    }
     ...
     * @mbggenerated Sat Apr 23 12:36:53 CST 2016
     */
    public int updateByExampleSelective(TbWebServer record, TbWebServerExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
        int rows = sqlMapClient.update("tb_web_server.updateByExampleSelective", parms);
        return rows;
    }
     ...
     * @mbggenerated Sat Apr 23 12:36:53 CST 2016
     */
    public int updateByExample(TbWebServer record, TbWebServerExample example) throws SQLException {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
     ...
     * @mbggenerated Sat Apr 23 12:36:53 CST 2016
     */
    public int updateByPrimaryKeySelective(TbWebServer record) throws SQLException {
        int rows = sqlMapClient.update("tb_web_server.updateByPrimaryKeySelective", record);
        return rows;
    }
    ...
    public int updateByPrimaryKey(TbWebServer record) throws SQLException {
        int rows = sqlMapClient.update("tb_web_server.updateByPrimaryKey", record);
        return rows;
    }
	...
	/* (non-Javadoc)
	 * @see com.bplow.netconn.aom.dao.TbWebServerDAO#queryWebServerForpage(com.bplow.netconn.aom.dao.entity.TbWebServer)
	 */
	@Override
	public IPagination queryWebServerForpage(TbWebServer record)
			throws SQLException {
		IPagination page = this.queryForPagenation("tb_web_server.selectCounts", "tb_web_server.selectPage", record);
		return page;
	}
}