	...
	public String obtainMenu(Map<String, Object> model,SysUser user,HttpServletRequest request){
		...
		if(null != loginUser && "admin".equals(loginUser.getUserName())){
		    menujson ="[{'id':'apidocs','iconCls':'icon-docs','text':'功能菜单','singleClickExpand':true,'leaf':false,'children':["+
                    ...
                    + "{'href':'aom/serverHost','text':'web服务器','id':'web服务器','isClass':true,'iconCls':'icon-cls','cls':'cls','leaf':true}"
                    + ""
                    + "]}"+
                    ...
                    "{'href':'sys/userList','text':'菜单','id':'菜单','isClass':true,'iconCls':'icon-cls','cls':'cls','leaf':true}," + 
                    "{'href':'sys/userList','text':'模块','id':'模块','isClass':true,'iconCls':'icon-cls','cls':'cls','leaf':true}," + 
                    "{'href':'sys/userList','text':'角色','id':'角色','isClass':true,'iconCls':'icon-cls','cls':'cls','leaf':true}," +
                    "{'href':'sys/userList','text':'机构','id':'机构','isClass':true,'iconCls':'icon-cls','cls':'cls','leaf':true}" +
                    "]}"+
     		"]";
